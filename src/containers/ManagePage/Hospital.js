...
class Hospital extends Component {
    ...
    onCloseModal() {
        this.setState({ open: false, currFloor: null, file: null, imagePreviewUrl: null })
    }
    onChange(e) {
        e.preventDefault();
        ...
        return _.map(hospital._floor_list, floor => {
            return (
                <tr key={floor._id} id={floor._id}>
                    ...
                    <td width="10%"><div className="btn btn-default" onClick={() => { this.onOpenModal(floor._id) }}>Open</div></td>
...
export default connect(mapStateToProps, {  fetchHospital, fetchFloor })(Hospital);